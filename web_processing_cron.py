...
def main():
   for configfile in os.listdir(WEB_CONFIG_DIR):
      ...
      if submit:
         ...
         common_functions.CallSubprocessOn(["/users/rsg/stgo/PycharmProjects/ARSF_web_processor/web_qsub.py", "-c", WEB_CONFIG_DIR + configfile, "--local"], redirect=False, quiet=False)
